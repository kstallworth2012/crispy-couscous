...
public class TeamsController {
	...
	@PutMapping(path="/{id}")
	public ResponseEntity<TeamsDTO> fullUpdateTeam(@PathVariable("id") String id, @RequestBody TeamsDTO _teamDTO){
	...
	public ResponseEntity<TeamsDTO> partialUpdate(@PathVariable("id") String id, @RequestBody TeamsDTO _teamDTO){
